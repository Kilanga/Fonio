...
ActiveRecord::Schema[7.1].define(version: 2026_07_30_130000) do
  ...
  create_table "audit_logs", force: :cascade do |t|
    ...
    t.index ["intervention_id"], name: "index_audit_logs_on_intervention_id"
    t.index ["technician_id"], name: "index_audit_logs_on_technician_id"
  end
  ...
  create_table "calls", force: :cascade do |t|
    ...
    t.string "issue_type"
    t.text "help_needed_description"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["call_e_call_id"], name: "index_calls_on_call_e_call_id"
    t.index ["edit_token"], name: "index_calls_on_edit_token", unique: true
    t.index ["intervention_id"], name: "index_calls_on_intervention_id"
  end

  create_table "daily_summary_calls", force: :cascade do |t|
    t.date "date"
    t.string "pm_phone"
    t.string "call_e_call_id"
    t.string "call_status"
  ...
  add_foreign_key "audit_logs", "interventions"
  add_foreign_key "audit_logs", "technicians"
  add_foreign_key "calls", "interventions"
  add_foreign_key "interventions", "technicians"
